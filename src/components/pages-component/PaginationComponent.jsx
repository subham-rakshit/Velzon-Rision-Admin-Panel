...
const PaginationComponent = ({ paginationDetails }) => {
  ...
  const [rowsPerPage, setRowsPerPage] = useState(
    paginationDetails.currentLimit || 9
  );
  ...
  useEffect(() => {
    const page = parseInt(
      searchParams.get("page") || paginationDetails.currentPage || 1
    );
    const limit = parseInt(
      searchParams.get("pageSize") || paginationDetails.currentLimit || 9
    );
