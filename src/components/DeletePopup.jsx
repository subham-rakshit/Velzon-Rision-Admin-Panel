...
const DeletePopup = ({ handleDelete, type, itemName, isProcessing }) => {
  return (
    <DialogContent
      className={`${globalStyleObj.backgroundLight900Dark300} border-none font-poppins-rg`}
    >
      <DialogHeader>
        <DialogTitle className="text-[16px] text-dark-weight-400 dark:text-light-weight-550">
          Are you absolutely sure?
        </DialogTitle>
        <DialogDescription className="text-light-weight-400 text-[13px] italic">
